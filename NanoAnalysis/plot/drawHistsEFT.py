...
year=['2017']
regions=["All","0Bjet","1Bjet", "G1Bjet"]
#regions=["ll","llOffZ"]
#regions=["ll","llB1", "llBg1"]
regionsName=["All","0Bjet","1Bjet", "$>$1Bjet"]
channels=[
#"EpEm", "MUpMUm", "EpmMUmp","LLpp","LLmm", "3LonZ", "3LoffZp", "3LoffZm","4L",
#                               "LFpp", "FFpp", "LFmm", "FFmm",
...
colors =  [ROOT.kBlack,ROOT.kGreen,ROOT.kBlue+8,ROOT.kRed-4,ROOT.kOrange-3, ROOT.kCyan+1, ROOT.kYellow, ROOT.kMagenta-4,ROOT.kYellow+2, ROOT.kGray+1,ROOT.kGray+3,]
