...
int TMVAClassification_TC_3lonZ()
{
    // Initialize TMVA
    TMVA::Tools::Instance();
    TFile* outputFile = TFile::Open("TMVAOutput_TC_3lonZ.root", "RECREATE");
    TMVA::Factory* factory = new TMVA::Factory("TMVAMulticlass_TC_3lonZ", outputFile,
