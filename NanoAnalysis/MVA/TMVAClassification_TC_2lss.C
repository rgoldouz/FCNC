...
int TMVAClassification_TC_2lss()
{
    // Initialize TMVA
    TMVA::Tools::Instance();
    TFile* outputFile = TFile::Open("TMVAOutput_TC_2lss.root", "RECREATE");
    TMVA::Factory* factory = new TMVA::Factory("TMVAClassification_TC_2lss", outputFile,
