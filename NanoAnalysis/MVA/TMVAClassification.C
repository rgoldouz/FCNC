/// \ingroup tutorial_tmva
 ...
 int TMVAClassification( TString myMethodList = "",TString coupling="cpQM",TCut sigCut="ch==5 && weightcpQM >0",TCut bgCut="ch==5 && weightcpQM >0",TString sigWeight="weightcpQM",TString bgWeight="weightSM")
 {
...
//    inputB1 = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/FCNC/NanoAnalysis/MVA/2017_FCNCProduction.root" ); 
    inputB1 = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/FCNC/NanoAnalysis/MVA/2017_totalBG.root" );
//    inputB2 = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/FCNC/NanoAnalysis/MVA/2017_Diboson.root" );

    inputS1 = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/FCNC/NanoAnalysis/MVA/2017_FCNCProduction.root" );
//    inputS1 = TFile::Open( "/afs/crc.nd.edu/user/r/rgoldouz/FCNC/NanoAnalysis/MVA/2017_tuFCNC_tllProduction_noH_skimmed.root" );

    TTree *background1     = (TTree*)inputB1->Get("FCNC");
//    TTree *background2     = (TTree*)inputB2->Get("FCNC");

    TTree *signalTree1     = (TTree*)inputS1->Get("FCNC");

 
    // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
    TString outfileName( coupling+"_TMVA.root" );
    ...
    TMVA::Factory *factory = new TMVA::Factory( coupling, outputFile,
    ...
    dataloader->AddVariable( "lep1Eta",                "lep1Eta", "", 'F' );
    dataloader->AddVariable( "lep2Eta",                "lep2Eta", "", 'F' );
    ...
    dataloader->AddVariable( "bJetEta",                "bJetEta", "", 'F' );
    dataloader->AddVariable( "nJets",                "nJets", "", 'I' );

    dataloader->AddVariable( "topMass",                "topMass", "GeV", 'F' );
    dataloader->AddVariable( "HZMass",                "HZMass", "GeV", 'F' );
    dataloader->AddVariable( "WtopMass",                "WtopMass", "GeV", 'F' );
    dataloader->AddVariable( "W1HMass",                "W1HMass", "GeV", 'F' );
    dataloader->AddVariable( "W2HMass",                "W2HMass", "GeV", 'F' );
    dataloader->AddVariable( "HZPt",                "HZPt", "GeV", 'F' );
    dataloader->AddVariable( "HZEta",                "HZEta", "", 'F' );
    dataloader->AddVariable( "topPt",                "topPt", "GeV", 'F' );
    dataloader->AddVariable( "topEta",                "topEta", "", 'F' );
    dataloader->AddVariable( "drWtopB",                "drWtopB", "", 'F' );
    dataloader->AddVariable( "drW1HW2H",                "drW1HW2H", "", 'F' );
...
//    dataloader->AddBackgroundTree( background2, backgroundWeight );
    ...
    //
   // dataloader->PrepareTrainingAndTestTree( "ch==5 && weightcpQM >= 0", "SplitMode=random:!V" );
    //
...
//                            "!H:!V:Boost_Num=30:Boost_Transform=linear:SigBgSeparate=F:MaxDepth=4:UseYesNoCell=T:DTLogic=MisClassificationError:FillFoamWithOrigWeights=F:TailCut=0:nActiveCells=500:nBin=20:Nmin=400:Kernel=None:Compress=T" );
    ...
    if (Use["BDTG"]) // Gradient Boost
       factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDTG",
                            "!H:!V:NTrees=300:MinNodeSize=5%:BoostType=Grad:Shrinkage=0.01:UseBaggedBoost:BaggedSampleFraction=0.3:nCuts=20:MaxDepth=3:ignorenegweightsintraining=True" );
