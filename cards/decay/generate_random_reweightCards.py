...
os.system('mkdir tllFcncDecay')
os.system('cp tllFCNC_proc_card.dat tllFcncDecay/tllFcncDecay_proc_card.dat')
os.system('cp tllFCNC_reweight_card.dat tllFcncDecay/tllFcncDecay_reweight_card.dat')
os.system('cp tllFCNC_customizecards.dat tllFcncDecay/tllFcncDecay_customizecards.dat')
os.system('cp tllFCNC_run_card.dat tllFcncDecay/tllFcncDecay_run_card.dat')
#os.system('cp tllFCNC_madspin_card.dat tllFCNC')
os.system('cp tllFCNC_extramodels.dat tllFcncDecay/tllFcncDecay_extramodels.dat')

for WC1 in couplingsName:
    os.system('rm -rf tllFCNC'+WC1)
    os.system('rm -rf tllFcncDecay'+WC1)
    os.system('mkdir tllFcncDecay'+WC1)
    os.system('cp tllFCNC_extramodels.dat tllFcncDecay'+WC1 + '/tllFcncDecay'+WC1 +'_extramodels.dat')
    os.system('cp tllFCNC_run_card.dat tllFcncDecay'+WC1 + '/tllFcncDecay'+WC1 +'_run_card.dat')
...
#    Ccards = Ccards + 'set dynamical_scale_choice 3\n'
    ...
    open('tllFcncDecay'+WC1+'_customizecards.dat', 'wt').write(Ccards)
    os.system('mv tllFcncDecay'+WC1+'_customizecards.dat tllFcncDecay'+WC1)
    process = ''
#    if WC1 in C4F:
...
#        process = process + 'import model dim6top_LO_UFO-full --modelname' + '\n'
    ...
    process = process + 'generate  p p > t  ell+ ell- FCNCj DIM6=0 FCNC=1 , (t  > w+ b DIM6=0 FCNC=0,  w+ > l+ vl DIM6=0 FCNC=0 ) @0' + '\n'
    process = process + 'add process  p p > t~  ell+ ell- FCNCj DIM6=0 FCNC=1 , (t~  > w- b~ DIM6=0 FCNC=0,  w- > l- vl~ DIM6=0 FCNC=0 ) @1' + '\n'
    process = process + 'output tllFcncDecay' + WC1 + ' -f -nojpeg'
    open('tllFcncDecay'+WC1 +'_proc_card.dat', 'wt').write(process)
    os.system('mv tllFcncDecay'+WC1+'_proc_card.dat tllFcncDecay'+WC1)
