...
process = process + 'define l- = e- m- tt-' + '\n'
process = process + 'generate  p p > t t~ /h a z ,  (t > UU~ DD~ m+ ) @0' + '\n'
process = process + 'add process  p p > t t~ /h a z , (t~ > UU DD m-)@1' + '\n'
...
#os.system('cp tllFCNC_extramodels.dat BNV_ttUDmuDecay/BNV_ttUDmuDecay_extramodels.dat')
