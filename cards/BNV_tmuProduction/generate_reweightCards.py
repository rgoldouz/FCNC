...
open('BNV_tmuProduction_customizecards.dat', 'wt').write(customizecards)
n=-1
rwgtCards = ''
...
open('BNV_tmuProduction_reweight_card.dat', 'wt').write(rwgtCards)
os.system('rm -rf BNV_tmuProduction')
os.system('mkdir BNV_tmuProduction')
process = ''
...
process = process + 'define l- = e- m- tt-' + '\n'
process = process + 'generate  p p > t~ m+ @0' + '\n'
process = process + 'add process  p p > t m- @1' + '\n'
process = process + 'output BNV_tmuProduction  -f -nojpeg'
open('BNV_tmuProduction_proc_card.dat', 'wt').write(process)
os.system('mv BNV_tmuProduction_proc_card.dat BNV_tmuProduction')
os.system('cp BNV_tmuProduction_reweight_card.dat BNV_tmuProduction/BNV_tmuProduction_reweight_card.dat')
os.system('cp BNV_tmuProduction_customizecards.dat BNV_tmuProduction/BNV_tmuProduction_customizecards.dat')
os.system('cp tllFCNC_run_card.dat BNV_tmuProduction/BNV_tmuProduction_run_card.dat')
#os.system('cp tllFCNC_extramodels.dat BNV_tmuProduction/BNV_tmuProduction_extramodels.dat')

#for WC1 in couplingsName:
#    os.system('rm -rf tllFCNC'+WC1)
#    os.system('rm -rf tllFcncProduction'+WC1)
#    os.system('rm -rf BNV_tmuProduction'+WC1)
#    os.system('mkdir BNV_tmuProduction'+WC1)
#    os.system('cp tllFCNC_extramodels.dat BNV_tmuProduction'+WC1 + '/BNV_tmuProduction'+WC1 +'_extramodels.dat')
#    os.system('cp tllFCNC_run_card.dat BNV_tmuProduction'+WC1 + '/BNV_tmuProduction'+WC1 +'_run_card.dat')
##    os.system('cp tllFCNC_madspin_card.dat BNV_tmuProduction'+WC1 + '/BNV_tmuProduction'+WC1 +'_madspin_card.dat')
#    os.system('cp tllFCNC_extramodels.dat BNV_tmuProduction'+WC1 + '/BNV_tmuProduction'+WC1 +'_extramodels.dat')
...
#    open('BNV_tmuProduction'+WC1+'_customizecards.dat', 'wt').write(Ccards)
#    os.system('mv BNV_tmuProduction'+WC1+'_customizecards.dat BNV_tmuProduction'+WC1)
#    process = ''
##    if WC1 in C4F:
...
#    process = process + 'output BNV_tmuProduction' + WC1 + ' -f -nojpeg'
#    open('BNV_tmuProduction'+WC1 +'_proc_card.dat', 'wt').write(process)
#    os.system('mv BNV_tmuProduction'+WC1+'_proc_card.dat BNV_tmuProduction'+WC1)
#
